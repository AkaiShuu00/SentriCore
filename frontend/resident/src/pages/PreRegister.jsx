...
import { CheckCircle2, User, Users, Truck } from 'lucide-react';
...
function SingleIcon() { return <User size={40} color={COLORS.teal} strokeWidth={2} />; }
function BatchIcon() { return <Users size={40} color={COLORS.teal} strokeWidth={2} />; }
function DeliveryIcon() { return <Truck size={40} color={COLORS.teal} strokeWidth={2} />; }
